# Install script for directory: /GLOBALFS/sysu_hpcscc_2/zhj/OpenCAEPoro_rep/OpenCAEPoro/main
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  if(EXISTS "$ENV{DESTDIR}/GLOBALFS/sysu_hpcscc_2/zhj/OpenCAEPoro_rep/OpenCAEPoro/testOpenCAEPoro" AND
  ...
  file(INSTALL DESTINATION "/GLOBALFS/sysu_hpcscc_2/zhj/OpenCAEPoro_rep/OpenCAEPoro" TYPE EXECUTABLE FILES "/GLOBALFS/sysu_hpcscc_2/zhj/OpenCAEPoro_rep/OpenCAEPoro/build/main/testOpenCAEPoro")
  if(EXISTS "$ENV{DESTDIR}/GLOBALFS/sysu_hpcscc_2/zhj/OpenCAEPoro_rep/OpenCAEPoro/testOpenCAEPoro" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/GLOBALFS/sysu_hpcscc_2/zhj/OpenCAEPoro_rep/OpenCAEPoro/testOpenCAEPoro")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/GLOBALFS/sysu_hpcscc_2/zhj/OpenCAEPoro_rep/OpenCAEPoro/testOpenCAEPoro"

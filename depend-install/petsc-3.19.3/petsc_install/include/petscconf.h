...
#define PETSC_ARCH "petsc_install"
...
#define PETSC_DEPRECATED_ENUM(why) __attribute__((deprecated))
...
#define PETSC_DIR "/GLOBALFS/sysu_hpcscc_2/zhj/OpenCAEPoro_rep/depend-install/petsc-3.19.3"
...
#define PETSC_HAVE_OMPI_MAJOR_VERSION 5
...
#define PETSC_MPICC_SHOW "icc -I/APP/u22/x86/mpi/openmpi-5.0.0-icc-oneapi2023.2-ch4/include -L/APP/u22/x86/mpi/openmpi-5.0.0-icc-oneapi2023.2-ch4/lib -Wl,-rpath -Wl,/APP/u22/x86/mpi/openmpi-5.0.0-icc-oneapi2023.2-ch4/lib -Wl,--enable-new-dtags -lmpi"
